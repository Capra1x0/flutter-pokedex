...
abstract class $PokemonCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int height, int weight, Sprites sprites});
...
class _$_Pokemon implements _Pokemon {
  ...
  @override
  String toString() {
    return 'Pokemon(id: $id, height: $height, weight: $weight, sprites: $sprites)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, height, weight, sprites);
